...
const N: u32 = N0 + N1 as u32; // !!! N must be smaller than 62 for current version.
...
pub fn biguint_to_digits(mut number: BigUint) -> [u8; N0 as usize] {
    let mut digits: [u8; N0 as usize] = [0; N0 as usize];
...
mod test {
    ...
    fn test_winternitz() {
        ...
        let message = biguint_to_digits(fq_biguint.clone());
