...
pub fn g1_projective_mul_inputs(g1: ark_bn254::G1Projective, scalar: ark_bn254::Fr, result: ark_bn254::G1Projective) -> Vec<Vec<ScriptInput>> {
    ...
    let mut inputs_bits = vec![ScriptInput::InputG1P(p), ScriptInput::InputG1P(two_p), ScriptInput::InputG1P(three_p)];
    for b in bits {
        inputs_bits.push(ScriptInput::InputBit(*b));
    }
...
pub fn fq12_mul_scripts() -> Vec<Script> {
    let mut scripts = Vec::new();
...
pub fn fq12_mul_inputs(a: ark_bn254::Fq12, b: ark_bn254::Fq12, c: ark_bn254::Fq12) -> Vec<Vec<ScriptInput>> {
    let mut inputs = Vec::new();

    let d = a.c0 * b.c0;

    inputs.push(vec![ScriptInput::InputFq6(d), ScriptInput::InputFq6(a.c0), ScriptInput::InputFq6(b.c0)]);

    let e = a.c1 * b.c1;

    inputs.push(vec![ScriptInput::InputFq6(e), ScriptInput::InputFq6(a.c1), ScriptInput::InputFq6(b.c1)]);

    inputs.push(vec![ScriptInput::InputFq6(a.c0), ScriptInput::InputFq6(a.c1), ScriptInput::InputFq6(b.c0), ScriptInput::InputFq6(b.c1), ScriptInput::InputFq6(d), ScriptInput::InputFq6(e), ScriptInput::InputFq12(c)]);
...
pub fn add_line_with_flag_scripts_and_inputs(flag: bool, t4: ark_bn254::G2Projective, q4x: ark_bn254::Fq2, q4y: ark_bn254::Fq2) -> Vec<(Script, Vec<ScriptInput>)> {
    let mut scripts_and_inputs = Vec::new();
    ...
    scripts_and_inputs.push((s1, vec![ScriptInput::InputFq2(theta), ScriptInput::InputFq2(lambda), ScriptInput::InputFq2(c), ScriptInput::InputFq2(d), ScriptInput::InputG2P(t4), ScriptInput::InputFq2(q4x), ScriptInput::InputFq2(q4y)]));
    ...
    scripts_and_inputs.push((s2, vec![ScriptInput::InputFq2(coeffs.0), ScriptInput::InputFq2(coeffs.1), ScriptInput::InputFq2(coeffs.2), ScriptInput::InputG2P(t4x), ScriptInput::InputG2P(t4), ScriptInput::InputFq2(q4x), ScriptInput::InputFq2(q4y), ScriptInput::InputFq2(theta), ScriptInput::InputFq2(lambda), ScriptInput::InputFq2(c), ScriptInput::InputFq2(d)]));

    scripts_and_inputs
}

pub fn add_line_with_flag_scripts(flag: bool) -> Vec<Script> {
    let mut scripts = Vec::new();
...
pub fn add_line_with_flag_inputs(flag: bool, t4: ark_bn254::G2Projective, q4x: ark_bn254::Fq2, q4y: ark_bn254::Fq2) -> Vec<Vec<ScriptInput>> {
    let mut inputs = Vec::new();
    ...
    inputs.push(vec![ScriptInput::InputFq2(theta), ScriptInput::InputFq2(lambda), ScriptInput::InputFq2(c), ScriptInput::InputFq2(d), ScriptInput::InputG2P(t4), ScriptInput::InputFq2(q4x), ScriptInput::InputFq2(q4y)]);

    inputs.push(vec![ScriptInput::InputFq2(coeffs.0), ScriptInput::InputFq2(coeffs.1), ScriptInput::InputFq2(coeffs.2), ScriptInput::InputG2P(t4x), ScriptInput::InputG2P(t4), ScriptInput::InputFq2(q4x), ScriptInput::InputFq2(q4y), ScriptInput::InputFq2(theta), ScriptInput::InputFq2(lambda), ScriptInput::InputFq2(c), ScriptInput::InputFq2(d)]);

    inputs
}

pub fn ell_by_constant_scripts_and_inputs(f: ark_bn254::Fq12, c0: ark_bn254::Fq2, c1: ark_bn254::Fq2, c2: ark_bn254::Fq2, p: ark_bn254::G1Affine, f2: ark_bn254::Fq12) -> Vec<(Script, Vec<ScriptInput>)> {
    let mut scripts_and_inputs = Vec::new();
    ...
    scripts_and_inputs.push((s1, vec![ScriptInput::InputFq6(a), ScriptInput::InputFq6(b), ScriptInput::InputFq12(f), ScriptInput::InputG1A(p)]));
    ...
    scripts_and_inputs.push((s2, vec![ScriptInput::InputFq12(fx), ScriptInput::InputFq6(a), ScriptInput::InputFq6(b), ScriptInput::InputFq12(f), ScriptInput::InputG1A(p)]));

    scripts_and_inputs
}

pub fn ell_by_constant_scripts(c0: ark_bn254::Fq2, c1: ark_bn254::Fq2, c2: ark_bn254::Fq2) -> Vec<Script> {
    let mut scripts = Vec::new();
...
pub fn ell_by_constant_inputs(f: ark_bn254::Fq12, c0: ark_bn254::Fq2, c1: ark_bn254::Fq2, c2: ark_bn254::Fq2, p: ark_bn254::G1Affine, f2: ark_bn254::Fq12) -> Vec<Vec<ScriptInput>> {
    let mut inputs = Vec::new();
    ...
    inputs.push(vec![ScriptInput::InputFq6(a), ScriptInput::InputFq6(b), ScriptInput::InputFq12(f), ScriptInput::InputG1A(p)]);

    inputs.push(vec![ScriptInput::InputFq12(fx), ScriptInput::InputFq6(a), ScriptInput::InputFq6(b), ScriptInput::InputFq12(f), ScriptInput::InputG1A(p)]);

    inputs
}

pub fn ell_scripts_and_inputs(f: ark_bn254::Fq12, c0: ark_bn254::Fq2, c1: ark_bn254::Fq2, c2: ark_bn254::Fq2, p: ark_bn254::G1Affine, f2: ark_bn254::Fq12) -> Vec<(Script, Vec<ScriptInput>)> {
    let mut scripts_and_inputs = Vec::new();
    ...
    scripts_and_inputs.push((s1, vec![ScriptInput::InputFq6(a), ScriptInput::InputFq6(b), ScriptInput::InputFq12(f), ScriptInput::InputFq2(c0), ScriptInput::InputFq2(c1), ScriptInput::InputFq2(c2), ScriptInput::InputG1A(p)]));
    ...
    scripts_and_inputs.push((s2, vec![ScriptInput::InputFq12(f2), ScriptInput::InputFq6(a), ScriptInput::InputFq6(b), ScriptInput::InputFq12(f), ScriptInput::InputFq2(c0), ScriptInput::InputFq2(c1), ScriptInput::InputFq2(c2), ScriptInput::InputG1A(p)]));

    scripts_and_inputs
}

pub fn ell_scripts() -> Vec<Script> {
    let mut scripts = Vec::new();
...
pub fn ell_inputs(f: ark_bn254::Fq12, c0: ark_bn254::Fq2, c1: ark_bn254::Fq2, c2: ark_bn254::Fq2, p: ark_bn254::G1Affine, f2: ark_bn254::Fq12) -> Vec<Vec<ScriptInput>> {
    let mut inputs = Vec::new();
    ...
    inputs.push(vec![ScriptInput::InputFq6(a), ScriptInput::InputFq6(b), ScriptInput::InputFq12(f), ScriptInput::InputFq2(c0), ScriptInput::InputFq2(c1), ScriptInput::InputFq2(c2), ScriptInput::InputG1A(p)]);

    inputs.push(vec![ScriptInput::InputFq12(f2), ScriptInput::InputFq6(a), ScriptInput::InputFq6(b), ScriptInput::InputFq12(f), ScriptInput::InputFq2(c0), ScriptInput::InputFq2(c1), ScriptInput::InputFq2(c2), ScriptInput::InputG1A(p)]);
...
pub fn groth16_inputs(proof: Proof<ark_bn254::Bn254>, public: Vec<<ark_bn254::Bn254 as ark_ec::pairing::Pairing>::ScalarField>, vk: VerifyingKey<ark_bn254::Bn254>) -> Vec<Vec<ScriptInput>> {
    ...
    inputs.push(vec![ScriptInput::InputG1P(msm_g1), ScriptInput::InputG1P(base2_times_public)]);
    ...
    for i in (1..ark_bn254::Config::ATE_LOOP_COUNT.len()).rev() {
        ...
        inputs.push(vec![ScriptInput::InputG2P(t4x), ScriptInput::InputFq2(coeffs.0), ScriptInput::InputFq2(coeffs.1), ScriptInput::InputFq2(coeffs.2), ScriptInput::InputG1A(p4), ScriptInput::InputG2P(t4_1)]);
        t4_1 = t4x;
        ...
        // inputs.push(vec![ScriptInput::InputFq12(fx), ScriptInput::InputFq12(f1), ScriptInput::InputFq2(coeffs.0), ScriptInput::InputFq2(coeffs.1), ScriptInput::InputFq2(coeffs.2), ScriptInput::InputG1A(p4)]);
    ...
    inputs.push(vec![ScriptInput::InputFq12(c_inv_p), ScriptInput::InputFq12(c_inv)]);
    ...
    inputs.push(vec![ScriptInput::InputFq12(c_p2), ScriptInput::InputFq12(c)]);
    ...
    inputs.push(vec![ScriptInput::InputFq2(q4y), ScriptInput::InputFq2(q4.y), ScriptInput::InputFq2(q4x), ScriptInput::InputFq2(q4.x)]);
    ...
    // inputs.push(vec![ScriptInput::InputFq12(fx), ScriptInput::InputFq12(f), ScriptInput::InputFq2(coeffs.0), ScriptInput::InputFq2(coeffs.1), ScriptInput::InputFq2(coeffs.2), ScriptInput::InputG1A(p4)]);
    ...
    inputs.push(vec![ScriptInput::InputFq2(q4x), ScriptInput::InputFq2(q4.x)]);
...
fn test_groth16_scripts_and_inputs() {
    ...
    let scripts = groth16_scripts(vk.clone());
    println!("len groth16 scripts: {:?}", scripts.len());

    let inputs = groth16_inputs(proof, public, vk);
    println!("len groth16 inputs: {:?}", inputs.len());

    assert_eq!(scripts.len(), inputs.len());

    for (i, (script, input)) in zip(scripts, inputs).enumerate() {
        print!("script [{}] ", i);
        assert!(test_script_with_inputs(script.clone(), input.to_vec()));
    }
}
...
fn test_groth16_split() {
    ...
    for i in (1..ark_bn254::Config::ATE_LOOP_COUNT.len()).rev() {
        ...
        for j in 0..num_constant {
            ...
            scripts_and_inputs.extend(ell_by_constant_scripts_and_inputs(f1, coeffs.0, coeffs.1, coeffs.2, p_lst[j], fx));
            f1 = fx;
        }
        ...
        scripts_and_inputs.extend(ell_scripts_and_inputs(f1, coeffs.0, coeffs.1, coeffs.2, p4, fx));
        f1 = fx;
        ...
        if ark_bn254::Config::ATE_LOOP_COUNT[i - 1] == 1 || ark_bn254::Config::ATE_LOOP_COUNT[i - 1] == -1 {
            ...
            scripts_and_inputs.extend(add_line_with_flag_scripts_and_inputs(ark_bn254::Config::ATE_LOOP_COUNT[i - 1] == 1, t4_1, q4.x, q4.y));
            t4_1 = t4x;
    ...
    for j in 0..num_constant {
        ...
        scripts_and_inputs.extend(ell_by_constant_scripts_and_inputs(f, coeffs.0, coeffs.1, coeffs.2, p_lst[j], fx));
        f = fx;
    }
    ...
    scripts_and_inputs.extend(add_line_with_flag_scripts_and_inputs(true, t4, q4x, q4y));
    t4 = t4x;
    ...
    scripts_and_inputs.extend(ell_scripts_and_inputs(f, coeffs.0, coeffs.1, coeffs.2, p4, fx));
    f = fx;
