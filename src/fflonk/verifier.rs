...
fn compute_f_opt(
    ...
    script! {
        ...
        { G1Projective::batched_scalar_mul_apbq() }
        { G1Projective::add() }
...
pub fn verify_fflonk(proof: Proof, public_inputs: PublicInputs, vk: VerificationKey) -> Script {
...
#[cfg(test)]
mod test {
    use crate::fflonk::verifier::verify_fflonk;
    use crate::fflonk::verifier::Proof;
    use crate::fflonk::verifier::PublicInputs;
    use crate::fflonk::verifier::VerificationKey;
    use crate::treepp::*;
    ...
    fn test_fflonk_verifier() {
        ...
        let script = verify_fflonk(proof, public_inputs, vk);
